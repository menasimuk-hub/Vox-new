...
بعد ما يوافق: وضّح إن دي مقابلة قصيرة بخصوص وظيفة {role}، جهّزه، واسأله «جاهز نبدأ؟» — متقولش «نكمل» ومتقولش «فرز قصيرة».
...
SERVICE_INTERVIEW_ROLE = (
    ...
    "متقلش استبيان. متعدّش التحية. متقولش نكمل ولا فرز قصيرة."
)
