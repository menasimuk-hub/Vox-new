...
def upgrade() -> None:
    ...
    if not _has_table("org_usage_periods"):
        op.create_table(
            "org_usage_periods",
            sa.Column("id", sa.String(length=36), primary_key=True),
