...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("search_title_keywords", sa.Text(), nullable=False, server_default=""),
        ...
        sa.Column("writing_instruction", sa.Text(), nullable=False, server_default=""),
        sa.Column("email_signature", sa.Text(), nullable=False, server_default=""),
