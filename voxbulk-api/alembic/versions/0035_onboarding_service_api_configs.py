...
def upgrade() -> None:
    ...
    if "organisation_compliance_configs" not in tables:
        op.create_table(
            ...
            sa.Column("id", sa.String(length=36), nullable=False),
            sa.Column("org_id", sa.String(length=36), nullable=False),
            sa.Column("outbound_call_windows_json", sa.Text(), nullable=False),
            sa.Column("whatsapp_windows_json", sa.Text(), nullable=False),
            ...
            sa.Column("contact_preference_rules_json", sa.Text(), nullable=False),
            sa.Column("created_at", sa.DateTime(), nullable=False),
            sa.Column("updated_at", sa.DateTime(), nullable=False),
            sa.ForeignKeyConstraint(["org_id"], ["organisations.id"]),
            sa.PrimaryKeyConstraint("id"),
    ...
    if "organisation_workflow_configs" not in tables:
        op.create_table(
            ...
            sa.Column("timing_rules_json", sa.Text(), nullable=False),
            sa.Column("allowed_actions_json", sa.Text(), nullable=False),
            sa.Column("forbidden_actions_json", sa.Text(), nullable=False),
            sa.Column("escalation_rules_json", sa.Text(), nullable=False),
            sa.Column("generated_profile_json", sa.Text(), nullable=False),
