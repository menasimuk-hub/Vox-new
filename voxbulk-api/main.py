...
def health_build():
    ...
    return {
        ...
        "final_feedback_direct_open_text_marker": data.get("final_feedback_direct_open_text_marker"),
        "final_feedback_direct_on_disk": data.get("final_feedback_direct_on_disk"),
        "final_feedback_direct_loaded": data.get("final_feedback_direct_loaded"),
