...
EMAIL_TEST_VARIABLES: dict[str, str] = {
    ...
    "doctor_name": "Alex Manager",
    "trial_line": "15-day free trial",
    "offer_line": "15-day free trial",
    "offer_summary": "Includes 15-day trial after signup.",
    "promo_name": "Sales offer · Starter plan",
    "plan_summary": "Professional · £199/mo · 300 calls, 500 WhatsApp, 300 SMS",
    ...
    "deleted_at": "11 June 2026 14:30 UTC",
    "retention_note": "Invoices and legally required billing records are retained without personal identifiers.",
    ...
    "usage_summary_html": (
        "<p>• Survey responses completed: 12</p>"
        "<p>• Interview sessions completed: 4</p>"
        "<p>• Active survey campaigns: 2</p>"
        "<p>• Active interview campaigns: 1</p>"
    ),
    "action_items": "<p>No action items this week.</p>",
    "recovery_items": "<p>No action items this week.</p>",
    "message_html": "",
