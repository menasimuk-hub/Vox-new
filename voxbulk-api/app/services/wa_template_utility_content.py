...
TOPIC_SAFE_AR: dict[str, str] = {
    ...
    "breakfast quality": "جودة الإفطار",
    "breakfast_quality": "جودة الإفطار",
    "breakfast": "الإفطار",
    "room cleanliness": "نظافة الغرفة",
    "room_cleanliness": "نظافة الغرفة",
    "check in experience": "تجربة تسجيل الوصول",
    "check_in_experience": "تجربة تسجيل الوصول",
    "check-in experience": "تجربة تسجيل الوصول",
