...
# Operational message/response data kept on VoxBulk servers (default).
DEFAULT_RETENTION_DAYS_MESSAGES = 90
DEFAULT_RETENTION_DAYS_RESPONSES = 90
# Voice audio and full transcripts — shorter window (provider media + sensitivity).
DEFAULT_RETENTION_DAYS_RECORDINGS = 30
DEFAULT_RETENTION_DAYS_TRANSCRIPTS = 30
