...
def _fill_en_human_behavior(code: str) -> None:
    ...
    p["human_behavior"] = (
        ...
        "answer that briefly in one short sentence first — never ignore it.\n"
        ...
        "then immediately invoke the Hangup tool. Never leave silence on an open line. "
...
def _fill_ar_human_behavior(code: str) -> None:
    ...
    p["human_behavior"] = (
        ...
        "لو قاطعك أو سأل سؤال جانبي (مثلاً إزيك؟ / مين معايا؟): جاوب بجملة قصيرة أولاً، "
        ...
        "لما تخلّص (إعادة جدولة / رفض تسجيل / إغلاق): قل مع السلامة مرة، بعدين Hangup فورًا. "
