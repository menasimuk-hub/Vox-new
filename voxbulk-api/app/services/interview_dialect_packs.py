...
def _canonical_flow_ar() -> str:
    return (
        ...
        "بعد مع السلامة: أنهِ المكالمة فورًا. متسيبش الخط مفتوح. متقولش «انتهت المكالمة» — مع السلامة وبعدين قطع.\n"
...
def _canonical_flow_en() -> str:
    return (
        ...
        "After goodbye: hang up / end the call immediately. Do not stay on the line. "
        "Do not say 'call ended' as a sentence — just goodbye, then disconnect.\n"
...
def _fill_en_human_behavior(code: str) -> None:
    ...
    p["human_behavior"] = (
        ...
        "then hang up / end the call immediately — never leave silence on an open line.\n"
        f"{p['listening']}\n"
