...
ARABIC_BASE_ROLE = (
    "تحدث بالعربية الخليجية بأسلوب طبيعي ومحترف (سعودي/إماراتي — مو فصحى رسمية). "
    "افهم إجابات المرشّح بكل اللهجات: خليجي (زين، تمام، يالله، حاضر)، مصري (إيه، تمام، ماشي، أيوه)، "
    "شامي/لبناني (منيح، كيفك، يلا، أكيد، طيب، مزبوط، يعني). "
    "رد دائمًا بأسلوب خليجي واضح وودود — لا ترد بالفصحى. توقف بعد كل سؤال. "
    "إذا ما فهمت، أعد السؤال مرة واحدة بصياغة أبسط. احترم المقاطعات."
)
    ...
    *,
    ...
    if use_arabic:
        parts.append(
            ...
            "التحية وجميع الأسئلة والمتابعات وكل ردودك. لا تستخدم فصحى رسمية إلا للمصطلحات المهنية عند الحاجة. "
