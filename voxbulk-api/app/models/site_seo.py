...
class SiteSeoSettings(Base):
    ...
    gsc_clicks: Mapped[str | None] = mapped_column(String(32), nullable=True)
    gsc_clicks_prev: Mapped[str | None] = mapped_column(String(32), nullable=True)
    gsc_impressions: Mapped[str | None] = mapped_column(String(32), nullable=True)
    gsc_impressions_prev: Mapped[str | None] = mapped_column(String(32), nullable=True)
    gsc_metrics_refreshed_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
