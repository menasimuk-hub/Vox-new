...
CAREER_MAILBOX_ROW_ID = 1


class CareerMailboxSettings(Base):
    __tablename__ = "career_mailbox_settings"

    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    mailbox_email: Mapped[str] = mapped_column(String(320), nullable=False, default="careers@voxbulk.com")
