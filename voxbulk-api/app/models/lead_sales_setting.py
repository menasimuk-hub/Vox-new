...
class LeadSalesSetting(Base):
    ...
    sales_automation_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    sales_auto_plan_code: Mapped[str] = mapped_column(String(64), nullable=False, default="starter")
    sales_auto_trial_days: Mapped[int] = mapped_column(Integer, nullable=False, default=15)
    sales_auto_offer_type: Mapped[str] = mapped_column(String(32), nullable=False, default="subscription_trial")
