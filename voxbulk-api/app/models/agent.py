...
class AgentDefinition(Base):
    ...
    service_appointment_role: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    supports_appointment: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    supports_ai_demo: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    ...
    is_default_appointment: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    is_default_ai_demo: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    ...
    disclosure_for_appointment: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
