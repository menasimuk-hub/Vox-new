...
class Settings(BaseSettings):
    ...
    # Test-only: allow AI follow-back dials outside Ofcom/org calling hours.
    ai_followup_relax_calling_hours: bool = Field(default=False, alias="AI_FOLLOWUP_RELAX_CALLING_HOURS")
    ...
    wa_messages_per_org_per_hour: int = Field(default=250, alias="WA_MESSAGES_PER_ORG_PER_HOUR")
    wa_messages_per_org_per_day: int = Field(default=2000, alias="WA_MESSAGES_PER_ORG_PER_DAY")
    ...
    wa_template_push_batch_size: int = Field(default=5, alias="WA_TEMPLATE_PUSH_BATCH_SIZE")
    wa_template_push_batch_pause_seconds: float = Field(default=3.0, alias="WA_TEMPLATE_PUSH_BATCH_PAUSE_SECONDS")
    interview_booking_token_max_days: int = Field(default=30, alias="INTERVIEW_BOOKING_TOKEN_MAX_DAYS")
