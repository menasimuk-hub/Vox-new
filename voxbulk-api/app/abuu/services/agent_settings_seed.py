...
def seed_agent_settings(db: Session) -> dict:
    ...
    row.greeting_template_en = row.greeting_template_en or "Hello {name}, what would you like to eat today?"
    row.greeting_template_ar = row.greeting_template_ar or "مرحباً {name}، ماذا تحب أن تأكل اليوم؟"
