...
def menu_item_to_dict(row: RestaurantMenuItem) -> dict:
    return {
        ...
        "allergen_tags_json": row.allergen_tags_json,
        "dietary_tags_json": row.dietary_tags_json,
        "recipe_tags_json": row.recipe_tags_json,
        "protein_tags_json": row.protein_tags_json,
        "cuisine_tags_json": row.cuisine_tags_json,
        "drink_tags_json": row.drink_tags_json,
        "upsell_tags_json": row.upsell_tags_json,
...
def order_to_dict(row: CustomerOrder, *, items: list | None = None, events: list | None = None) -> dict:
    return {
        ...
        "notes": row.notes,
        "allergy_note": getattr(row, "allergy_note", None),
