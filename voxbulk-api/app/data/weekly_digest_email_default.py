...
WEEKLY_DIGEST_BODY = wrap_brand_email(
  ...
  <div style="margin:20px 0;padding:16px;background:#f5f1ea;border-radius:12px;border:1px solid #e5e0d8;">
    <p style="margin:0 0 10px;font-size:13px;font-weight:600;color:#1a2d5c;">This week at a glance</p>
    {{usage_summary_html}}
  </div>
  <div style="margin:20px 0;padding:16px;background:#f5f1ea;border-radius:12px;border:1px solid #e5e0d8;">
    <p style="margin:0 0 10px;font-size:13px;font-weight:600;color:#1a2d5c;">Action items</p>
    {{action_items}}
  </div>
  <div style="margin:20px 0;padding:16px;background:#f5f1ea;border-radius:12px;border:1px solid #e5e0d8;">
