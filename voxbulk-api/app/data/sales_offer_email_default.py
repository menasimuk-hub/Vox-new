...
SALES_OFFER_EMAIL_BODY = wrap_brand_email(
    ...
    badge="Special offer",
    inner_html="""<p style="margin:0 0 16px;">Hi <strong>{{first_name}}</strong>,</p>
  <p style="margin:0 0 16px;">Thanks for speaking with us. Your VOXBULK <strong>{{offer_line}}</strong> is ready:</p>
  ...
  """
    ...
    + """
  <p style="word-break:break-all;font-size:13px;color:#6b6560;margin-top:16px;">
    <a href="{{signup_url}}" style="color:#185fa5;">{{signup_url}}</a>
  </p>
  <p style="font-size:13px;color:#6b6560;margin-top:12px;">Your offer applies automatically when you sign up with this link.</p>""",
