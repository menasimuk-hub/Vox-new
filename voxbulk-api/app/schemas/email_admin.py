...
class SupportMailboxSettingsUpdate(BaseModel):
    mailbox_email: str = Field(default="support@voxbulk.com")
    from_name: str = Field(default="VOXBULK Support")
    smtp_username: str | None = Field(default="")
    smtp_host: str | None = Field(default="")
    ...
    imap_username: str | None = Field(default="")
    password: str | None = None
    sync_interval_minutes: int = Field(default=5, ge=1, le=240)
    is_enabled: bool = False
