    ...
    articles: [
      {
        ...
        title: "What is the Overview page?",
        routes: ["/"],
        body: "The Overview is your home page after you sign in. It shows a quick snapshot of the services your organisation has turned on — for example live interview calls, survey activity, QR scans, and recent campaign stats.\n\nYou do not need to open every module to see what is happening today.",
      },
      {
        id: "overview-why",
        group: "Why would I use it?",
        title: "When to start on Overview",
        routes: ["/"],
        body: "Use Overview when you want to:\n\n• Check that campaigns are running as expected\n• Spot a quiet day vs a busy day\n• Jump into the right module without hunting through the sidebar\n• Start a new campaign from one place",
      },
      {
        id: "overview-how-to",
        group: "How to use",
        title: "Step-by-step: use the home page",
        routes: ["/"],
        body: "1. Sign in and open the dashboard home (/).\n2. Read the KPI cards for the modules you use.\n3. Click a KPI or shortcut to open that module’s detail page.\n4. Use New campaign (when shown) to pick a product and start a draft.\n5. Use Ask AI / the help bubble if you need guidance without leaving the page.",
      },
      {
        id: "overview-actions",
        group: "Common actions",
        title: "Buttons and shortcuts on Overview",
        routes: ["/"],
        body: "• KPI cards — click to open the related results or module page.\n• New campaign — opens a picker for the products you can create (Interview, Survey, Feedback, and others you have enabled).\n• Ask AI / support bubble — answers questions and can help you open a support ticket.\n• Sidebar — switch modules anytime; Overview does not replace your product pages.",
      },
      {
        id: "overview-tips",
        group: "Tips",
        title: "What the KPI cards mean",
        body: "• AI interview calls live — candidates currently on the phone with Leo.\n• AI survey calls live — outbound survey calls in progress.\n• Calls attempted vs completed — completion rate for the current period.\n• Total scans — QR code scans (Customer Feedback) for the period.\n\nOnly cards for services you can see appear. If a service is missing, check Settings → Services (owners and managers).",
      },
      {
        id: "overview-avoid",
        group: "Things to avoid",
        title: "Common mistakes on the home page",
        body: "• Do not assume a missing module is broken — it may be turned off under Settings → Services, or not included in your plan.\n• Do not use Overview numbers as your only report for audits — open Results / Usage for the full breakdown.\n• Accountant users mainly see Account pages; they will not see product KPIs.",
      },
      {
        id: "overview-related",
        group: "Related features",
        title: "Where to go next",
        body: "• Documentation & FAQ — /account/support/faq\n• Billing and usage — /account/billing and /account/usage\n• Turn modules on or off — /settings/services (Owner / Manager)",
      },
    ],
  },
  {
    ...
    articles: [
      {
        ...
        routes: ["/interviews"],
        body: "AI Interviews help you screen many candidates by phone without dialling each one yourself.\n\nYou upload CVs or candidate details, approve a short interview script, and invite people to book a slot. At the booked time, voice AI (Leo) calls them, asks your questions, and saves a scorecard with audio and a transcript for your team.",
      },
      {
        id: "interviews-why",
        group: "Why would I use it?",
        title: "When AI Interviews help",
        routes: ["/interviews"],
        body: "Use AI Interviews when you need to:\n\n• Screen a large applicant list quickly\n• Keep every candidate on the same fair question set\n• Review scores and recordings in one place\n• Free recruiters for later-stage human interviews",
      },
      {
        id: "interviews-how-to",
        group: "How to use",
        title: "Step-by-step: launch your first interview campaign",
        routes: ["/interviews/new", "/interviews"],
        body: "1. Go to Interviews → New (/interviews/new).\n2. Enter the role and brief (must-haves and deal-breakers).\n3. Upload CVs (PDF/Word) or add candidates another way your account supports.\n4. Generate the script, edit any questions you want, then click Approve script.\n5. Set the calling window (when Leo is allowed to dial).\n6. Click Launch. Candidates get an invite with a booking link.\n7. Candidates pick a short slot; Leo calls at that time.\n8. Open Interviews → Results to review scorecards, audio and transcripts.",
      },
      {
        id: "interviews-actions",
        group: "Common actions",
        title: "Buttons you will use in Interviews",
        routes: ["/interviews", "/interviews/new", "/interviews/results"],
        body: "• New / Create — start a draft campaign.\n• Generate / Re-generate — draft or refresh the interview script from your brief.\n• Approve script — locks the version used on calls (required before Launch).\n• Launch — starts invites; Launch stays off until the script is approved and billing allows it.\n• Save / Edit on a live campaign — update settings for candidates not yet called.\n• Results — open scorecards, recordings and transcripts.\n• Send booking invite (where shown) — email/WhatsApp booking link after connecting a calendar provider.\n\nDeletes and major changes may ask for confirmation. Completed calls keep their existing reports.",
      },
      {
      ...
      },
      {
        id: "interviews-tips",
        group: "Tips",
        title: "Helpful tips for better interview campaigns",
        body: "• Use clear role criteria so scores are easier to compare.\n• Keep scripts short so candidates finish the call.\n• Check Settings → Opt-out before large launches.\n• Connect a booking provider under Settings → Integrations if you want calendar booking links.\n• Review a few early scorecards before you scale volume.",
      },
      {
        id: "interviews-avoid",
        group: "Things to avoid",
        title: "Things to avoid with AI Interviews",
        body: "• Do not launch with an unapproved script — Launch stays disabled on purpose.\n• Do not use numbers without a country code (use +44… style numbers).\n• Do not message or call numbers on your Opt-out list.\n• Do not expect script edits to change candidates who already completed a call.\n• Do not schedule slots right against the end of your calling window — leave buffer time.",
      },
      {
        id: "interviews-results",
        group: "Results & reports",
        title: "Where to find scorecards and reports",
        routes: ["/interviews/results", "/interviews/reports"],
        body: "• Interviews → Results (/interviews/results) — per-candidate scorecards, audio, transcripts and recommendations.\n• Open a campaign from Interviews to manage that campaign’s settings.\n• Reports (/interviews/reports) — wider hiring analytics across campaigns when available.\n\nExport options appear on results screens where your plan supports them.",
      },
      {
        id: "interviews-related",
        group: "Related features",
        title: "Related features",
        body: "• Billing and usage — /account/billing · /account/usage\n• Opt-out list — /settings/opt-out\n• Booking / CRM connections — /settings/integrations\n• Help and tickets — /account/support/faq · /account/support/tickets",
      },
      {
    ...
    articles: [
      {
        ...
        group: "What is it for",
        title: "What WhatsApp Surveys are",
        routes: ["/surveys"],
        body: "WhatsApp Surveys ask people questions inside WhatsApp chat — the app they already use.\n\nYou upload a contact list, choose or build a question flow, make sure the message template is approved, then launch. Replies come back into your dashboard automatically.",
      },
      {
        id: "wa-survey-why",
        group: "Why would I use it?",
        title: "When to choose WhatsApp Surveys",
        routes: ["/surveys"],
        body: "Choose WhatsApp when you want:\n\n• Higher reply rates than email forms\n• Step-by-step questions in chat\n• Optional branching (different next questions based on an answer)\n• A written transcript of replies in Results",
      },
      {
        id: "wa-survey-how-to",
        group: "How to use",
        title: "Step-by-step: launch a WhatsApp survey",
        routes: ["/surveys/new", "/surveys", "/surveys/results"],
        body: "1. Go to Surveys → New (/surveys/new) and choose the WhatsApp channel.\n2. Upload your contact list (CSV) with valid phone numbers.\n3. Build or pick your question flow (fixed order, or branching where offered).\n4. Confirm the WhatsApp template is approved / live.\n5. Approve your survey script if the screen asks you to.\n6. Click Launch and monitor progress.\n7. Open Surveys → Results for transcripts and summaries.",
      },
      {
        id: "wa-survey-actions",
        group: "Common actions",
        title: "Buttons you will use in Surveys",
        routes: ["/surveys", "/surveys/results"],
        body: "• New — start a survey draft.\n• Upload contacts — add recipients from a file.\n• Approve — lock script / template readiness where required.\n• Launch — start sending; disabled if templates or billing block you.\n• Results — replies, rates and exports where available.\n• Open a saved survey — manage or review that campaign.\n\nDo not edit live template wording mid-send — WhatsApp needs the approved text.",
      },
      {
        id: "wa-survey-tips",
        group: "Tips",
        title: "Helpful tips for WhatsApp surveys",
        body: "• Keep questions short and clear.\n• Test with one of your own numbers first.\n• Check Settings → Opt-out before large sends.\n• Wait for Meta approval on new or edited templates before launching.",
      },
      {
        id: "wa-survey-avoid",
        group: "Things to avoid",
        title: "Things to avoid",
        body: "• Do not message numbers that replied STOP.\n• Do not launch with a draft or pending template.\n• Do not change approved template wording mid-campaign.\n• Do not upload numbers without a country code.",
      },
      {
        id: "wa-survey-results",
        group: "Results & reports",
        title: "Where to see survey replies",
        routes: ["/surveys/results", "/surveys/reports"],
        body: "• Surveys → Results — reply transcripts, completion and key metrics.\n• Reports — trends across surveys when available.\n• Usage charges appear under Account → Usage.",
      },
      {
        id: "wa-survey-related",
        group: "Related features",
        title: "Related features",
        body: "• AI phone surveys (same Surveys area, different channel)\n• Opt-out — /settings/opt-out\n• Billing — /account/billing\n• FAQ — /account/support/faq",
      },
      {
    ...
    articles: [
      {
        ...
        group: "What is it for",
        title: "What AI Calling Surveys are",
        routes: ["/surveys"],
        body: "AI Calling Surveys reach people by phone. The voice AI dials your list, asks your questions aloud, listens to spoken answers, and saves structured results in the dashboard.\n\nThis uses the Surveys area with the AI phone call channel (not WhatsApp chat).",
      },
      {
        id: "wa-calling-why",
        group: "Why would I use it?",
        title: "When phone surveys work best",
        routes: ["/surveys"],
        body: "Use phone surveys when:\n\n• Your audience prefers a call to a chat\n• You need quick yes/no or short-score answers\n• You want outreach for reminders or simple polls at scale",
      },
      {
        id: "wa-calling-how-to",
        group: "How to use",
        title: "Step-by-step: launch a calling survey",
        routes: ["/surveys/new", "/surveys/results"],
        body: "1. Go to Surveys → New and choose the AI phone call channel.\n2. Import a CSV of phone numbers with country codes.\n3. Choose or build a short script and set the calling window.\n4. Approve the script if asked, then Launch.\n5. Review answers under Surveys → Results.",
      },
      {
        id: "wa-calling-actions",
        group: "Common actions",
        title: "Common actions on calling surveys",
        body: "• New — create a call survey.\n• Import numbers — upload recipients.\n• Set calling window — when dialling is allowed.\n• Launch — start dialling.\n• Results — listen to / read captured answers.\n\nLaunch can be blocked by billing, opt-outs, or an unapproved script.",
      },
      {
        id: "wa-calling-tips",
        group: "Tips",
        title: "Tips for clearer phone answers",
        body: "• Prefer Yes/No or 1–10 style questions.\n• Say up front that the call is an automated survey.\n• Keep the script short so people stay on the line.",
      },
      {
        id: "wa-calling-avoid",
        group: "Things to avoid",
        title: "Things to avoid",
        body: "• Do not dial outside allowed hours unless Relaxed Hours is on.\n• Do not use long open-ended questions on phone polls — use WhatsApp Surveys for longer text.\n• Do not upload numbers without a country code.",
      },
      {
        id: "wa-calling-results",
        group: "Results & reports",
        title: "Where results appear",
        routes: ["/surveys/results"],
        body: "Open Surveys → Results for transcripts, completion and summaries. Usage appears under Account → Usage.",
      },
      {
        id: "wa-calling-related",
        group: "Related features",
        title: "Related features",
        body: "• WhatsApp Surveys (same Surveys module, chat channel)\n• Opt-out — /settings/opt-out\n• Billing — /account/billing",
      },
      {
    ...
    articles: [
      {
        id: "feedback-purpose",
        group: "What is it for",
        title: "What Customer Feedback QR is",
        routes: ["/feedback"],
        body: "Customer Feedback captures reviews at your physical locations with a printed QR code.\n\nGuests scan the code, WhatsApp opens with a short survey, and answers appear on your dashboard by branch — including topic scores and trends.",
      },
      {
        id: "feedback-why",
        group: "Why would I use it?",
        title: "When QR feedback helps",
        routes: ["/feedback"],
        body: "Use it when you want:\n\n• Feedback at the moment of the visit\n• Separate scores per branch or site\n• Simple topic ratings (cleanliness, staff, wait time, and similar)\n• Printed material that stays valid while you tweak questions",
      },
      {
        id: "feedback-how-to",
        group: "How to use",
        title: "Step-by-step: launch QR feedback at a branch",
        routes: ["/feedback/new", "/feedback", "/feedback/results"],
        body: "1. Go to Feedback → New (/feedback/new) and add a location / branch.\n2. Choose your industry topics (up to the limit shown on screen).\n3. Download or print the unique QR for that branch.\n4. Place codes at reception, waiting areas or exits.\n5. Guests scan and complete the WhatsApp survey.\n6. Track scores under Feedback → Results.\n7. Use Compare locations (/feedback/compare) on multi-location plans.",
      },
      {
        id: "feedback-actions",
        group: "Common actions",
        title: "Buttons you will use in Feedback",
        routes: ["/feedback", "/feedback/results", "/feedback/compare"],
        body: "• New — create a location and QR.\n• Edit survey — change topics or closing text without reprinting the QR.\n• Download / print QR — get the image for that location.\n• Results — responses, scores and exports.\n• Compare — side-by-side branches (multi-location plans).\n\nAvoid deleting a location that already has printed codes in the wild — that breaks those QRs.",
      },
      {
        id: "feedback-tips",
        group: "Tips",
        title: "Helpful tips",
        body: "• Print clear, high-contrast QR codes.\n• Place them where guests naturally pause.\n• Review Results weekly so issues do not pile up.\n• Keep topic lists short so guests finish the survey.",
      },
      {
        id: "feedback-avoid",
        group: "Things to avoid",
        title: "Things to avoid",
        body: "• Do not hand-edit the pre-filled WhatsApp message on the QR.\n• Do not delete a branch just to “reset” questions — use Edit survey instead.\n• Do not expect Starter (single location) plans to show Compare.",
      },
      {
        id: "feedback-results",
        group: "Results & reports",
        title: "Results, compare and billing",
        routes: ["/feedback/results", "/feedback/compare", "/account/packages"],
        body: "• Feedback → Results — branch scores and topic breakdowns.\n• Feedback → Compare — multi-branch charts on eligible plans.\n• Packages — /account/packages (Customer Feedback tab) for location limits.",
      },
      {
        id: "feedback-related",
        group: "Related features",
        title: "Related features",
        body: "• Outbound feedback campaigns (add-on) — /feedback/campaigns\n• Support — /account/support/faq\n• Billing — /account/billing",
      },
      {
    ...
    articles: [
      {
        ...
        routes: ["/feedback/campaigns", "/feedback/campaigns/send"],
        body: "Outbound feedback campaigns invite customers to leave feedback on WhatsApp without scanning a QR — useful after a visit or purchase.\n\nThis only appears when Feedback campaigns are enabled for your organisation (Settings → Services, and allowed on your plan).",
      },
      {
        id: "feedback-campaigns-why",
        group: "Why would I use it?",
        title: "When to send feedback by message",
        body: "Use send campaigns when guests are not in the venue, or when you want follow-up feedback after an appointment or delivery.",
      },
      {
        id: "feedback-campaigns-how-to",
        group: "How to use",
        title: "Step-by-step: send a feedback campaign",
        routes: ["/feedback/campaigns/send", "/feedback/campaigns"],
        body: "1. Open Feedback → Campaigns (/feedback/campaigns).\n2. Start a new send (/feedback/campaigns/send).\n3. Choose questions / template and upload contacts.\n4. Confirm consent and purpose settings.\n5. Launch and monitor delivery and replies.\n\nPeople who reply STOP are added to your Opt-out list automatically.",
      },
      {
        id: "feedback-campaigns-actions",
        group: "Common actions",
        title: "Common actions",
        body: "• New send — create an outbound invite.\n• Upload contacts — add recipients.\n• Launch — start delivery.\n• Campaign list — monitor status.\n\nHonour STOP; do not re-add opted-out numbers.",
      },
      {
        id: "feedback-campaigns-tips",
        group: "Tips",
        title: "Tips",
        body: "• Message soon after the visit while the experience is fresh.\n• Keep the invite short.\n• Check Opt-out before large sends.",
      },
      {
        id: "feedback-campaigns-avoid",
        group: "Things to avoid",
        title: "Things to avoid",
        body: "• Do not send marketing messages without a lawful basis / consent.\n• Do not keep messaging numbers that opted out.\n• Do not expect this menu if the add-on is not enabled.",
      },
      {
        id: "feedback-campaigns-related",
        group: "Related features",
        title: "Related features",
        body: "• QR feedback locations — /feedback\n• Opt-out — /settings/opt-out\n• Billing — /account/billing",
      },
    ],
  },
  {
    ...
    articles: [
      {
        ...
        routes: ["/expo"],
        body: "Expo captures leads at trade shows and events. Visitors scan a branded QR or open a link, answer a few questions, and your team collects contacts under Expo → Leads.",
      },
      {
        id: "expo-why",
        group: "Why would I use it?",
        title: "When Expo helps",
        routes: ["/expo"],
        body: "Use Expo when you need:\n\n• A booth QR or shareable link for an event\n• Structured lead questions instead of paper forms\n• Catalogues / offers visitors can browse\n• Exportable leads after the show",
      },
      {
        id: "expo-how-to",
        group: "How to use",
        title: "Step-by-step: create an Expo booth",
        routes: ["/expo/new", "/expo", "/expo/leads"],
        body: "1. Open Expo → New (/expo/new).\n2. Enter the event name, questions and branding.\n3. Add catalogues if you want visitors to download materials (/expo/catalogues).\n4. Publish, then print or display the QR / share the link on the stand.\n5. Watch leads arrive under Expo → Leads.\n6. Export or mark follow-ups after the event.\n7. Manage capacity under Account → Packages (Expo) if needed.",
      },
      {
        id: "expo-actions",
        group: "Common actions",
        title: "Buttons you will use in Expo",
        routes: ["/expo", "/expo/leads", "/expo/catalogues"],
        body: "• New — create a booth / event.\n• Edit — update event details; published QR usually stays valid.\n• Print / download QR — material for the stand.\n• Catalogues — upload or manage PDFs / products.\n• Leads — sort, score, mark follow-up, export.\n• Save — keep draft changes before publish.",
      },
      {
        id: "expo-tips",
        group: "Tips",
        title: "Helpful tips for events",
        body: "• Test the QR on a phone before the show opens.\n• Keep questions short so visitors finish at the booth.\n• Export leads daily during multi-day events.\n• Confirm your package covers expected volume.",
      },
      {
        id: "expo-avoid",
        group: "Things to avoid",
        title: "Things to avoid",
        body: "• Do not wait until doors open to publish the booth.\n• Do not rely only on one printed copy — keep a spare QR.\n• Do not delete an active event mid-show if printed codes are already out.",
      },
      {
        id: "expo-results",
        group: "Results & reports",
        title: "Leads and summaries",
        routes: ["/expo/leads"],
        body: "Expo → Leads lists every submission. Filter or sort as shown on the page, mark follow-up, and export for your CRM.\n\nVisitors may also receive an email summary when that feature is enabled for the booth.",
      },
      {
        id: "expo-related",
        group: "Related features",
        title: "Related features",
        body: "• Smart Card QR (personal rep codes) — /smart-card\n• Packages — /account/packages\n• FAQ — /account/support/faq",
      },
      {
        id: "expo-troubleshoot",
        group: "Troubleshooting",
        title: "Problem: visitors scanned but leads are missing",
        body: "Do:\n• Confirm the booth is published in Expo.\n• Ask when they submitted and which stand / QR they used.\n• Check Expo → Leads filters (date, stand).\n\nDon't:\n• Don't assume a draft booth is collecting live leads — publish first.",
      },
    ],
  },
  {
    ...
    articles: [
      {
        ...
        routes: ["/smart-card"],
        body: "Smart Card gives each sales representative a personal QR code. Prospects scan it, share contact details and interest, and leads appear in your Smart Card workspace for follow-up.",
      },
      {
        id: "smart-card-why",
        group: "Why would I use it?",
        title: "When Smart Cards help",
        body: "Use Smart Cards when reps meet people face-to-face and need a fast way to capture leads without paper — networking, site visits, or retail floors.",
      },
      {
        id: "smart-card-how-to",
        group: "How to use",
        title: "Step-by-step: create a Smart Card QR",
        routes: ["/smart-card/new", "/smart-card", "/smart-card/leads"],
        body: "1. Open Smart Card → New (/smart-card/new) or /smart-card.\n2. Set company details and questions / offers as the wizard shows.\n3. Add representatives and activate their QR seats.\n4. Download or print each rep’s QR.\n5. Manage catalogues under Smart Card → Catalogue.\n6. Review leads under Smart Card → Leads.\n7. Adjust packages under Account when you need more capacity.",
      },
      {
        id: "smart-card-actions",
        group: "Common actions",
        title: "Buttons you will use",
        routes: ["/smart-card", "/smart-card/leads", "/smart-card/catalogue"],
        body: "• New — start a Smart Card setup.\n• Add representative / QR — create another personal code.\n• Download QR — get the image for cards or badges.\n• Catalogue — manage products visitors can browse.\n• Leads — filter by rep, mark follow-up, export.\n• Edit — update questions or company details.",
      },
      {
        id: "smart-card-tips",
        group: "Tips",
        title: "Helpful tips",
        body: "• Put the rep’s name on printed material so prospects trust the scan.\n• Keep questions short.\n• Review leads the same day while the conversation is fresh.",
      },
      {
        id: "smart-card-avoid",
        group: "Things to avoid",
        title: "Things to avoid",
        body: "• Do not share one QR across many reps if you need per-person attribution.\n• Do not ignore package limits — new QRs may need capacity.\n• Do not delete a rep’s QR while cards are still in circulation.",
      },
      {
        id: "smart-card-results",
        group: "Results & reports",
        title: "Where leads appear",
        routes: ["/smart-card/leads"],
        body: "Smart Card → Leads shows submissions by card / representative. Filter, follow up and export from that page.",
      },
      {
        id: "smart-card-related",
        group: "Related features",
        title: "Related features",
        body: "• Expo (event booths) — /expo\n• Packages — /account/packages\n• FAQ — /account/support/faq",
      },
      {
        id: "smart-card-troubleshoot",
        group: "Troubleshooting",
        title: "Problem: a scan did not create a lead",
        body: "Do:\n• Confirm the QR is active and the package allows it.\n• Ask which representative / card was scanned and when.\n• Check Leads filters.\n\nDon't:\n• Don't assume a draft or inactive card is collecting live leads.",
      },
    ],
  },
  {
    ...
    articles: [
      {
        ...
        routes: ["/campaigns"],
        body: "Broadcast campaigns are for sending approved WhatsApp template messages to a contact list — announcements, offers or updates.\n\nThey are not the same as conversational surveys. Delivery depends on approved templates and your opt-out rules.",
      },
      {
        id: "campaigns-why",
        group: "Why would I use it?",
        title: "When to use broadcasts",
        body: "Use Campaigns when you need a one-way (or template-based) WhatsApp send to many people at once, and you already have consent where marketing rules require it.",
      },
      {
        id: "campaigns-how-to",
        group: "How to use",
        title: "Step-by-step: create and send a campaign",
        routes: ["/campaigns/new", "/campaigns", "/campaigns/send"],
        body: "1. Open Campaigns (/campaigns) or Campaigns → New (/campaigns/new).\n2. Choose an approved WhatsApp template (pending templates cannot send).\n3. Upload contacts with valid phone numbers (country code included).\n4. Confirm purpose / consent settings for marketing sends.\n5. Use Send (/campaigns/send) when your account supports it, then monitor delivery on the campaign page.\n\nNote: some Campaign screens may still be limited while the product is rolled out. If a button does nothing or a step looks incomplete, open a support ticket — do not invent a workaround that skips consent or template approval.\n\nIf Campaigns is missing from the sidebar, enable it under Settings → Services (when allowed on your plan).",
      },
      {
        id: "campaigns-actions",
        group: "Common actions",
        title: "Common actions",
        body: "• New — start a template campaign draft.\n• Send — choose template and audience when available.\n• Open a campaign — review status.\n• Launch / Send — blocked until templates and billing allow it.",
      },
      {
        id: "campaigns-tips",
        group: "Tips",
        title: "Tips",
        body: "• Only use Meta-approved templates.\n• Test with a small list first.\n• Check Settings → Opt-out before large sends.",
      },
      {
        id: "campaigns-avoid",
        group: "Things to avoid",
        title: "Things to avoid",
        body: "• Do not send marketing broadcasts without a lawful basis.\n• Do not re-add STOP numbers.\n• Do not edit approved template wording mid-send.",
      },
      {
      ...
      {
        id: "campaigns-related",
        group: "Related features",
        title: "Related features",
        body: "• WhatsApp Surveys — /surveys\n• Opt-out — /settings/opt-out\n• Billing — /account/billing\n• Support — /account/support/tickets",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        group: "How to use",
        title: "Step-by-step: change your password",
        routes: ["/settings/profile"],
        body: "1. Open Settings → Profile (/settings/profile).\n2. Find Change password.\n3. Enter your current password.\n4. Enter a new password (at least 8 characters) and confirm it.\n5. Save. You should see a success message.\n\nIf you cannot sign in at all, use Forgot password on the login page instead.",
      },
      {
        id: "settings-roles",
        group: "Tips",
        title: "Who can see what (roles in plain English)",
        body: "• Owner / Manager — full modules you have enabled, plus Settings and usually Billing.\n• Member — campaign modules; profile view; no billing or team management.\n• Accountant — Account / billing area only; not the product workspaces.\n\nIf a teammate cannot see a module, check their role under Settings → Team and whether the service is on under Settings → Services.",
      },
      {
    ...
    articles: [
      {
        ...
        routes: ["/account/support", "/account/support/faq", "/account/support/tickets"],
        body: "The support hub gives you three ways to get help:\n\n• Documentation & FAQ — this Help Centre (/account/support/faq)\n• Live chat — VoxBulk assistant (help bubble)\n• Email tickets — open and track tickets at /account/support/tickets\n\nStart at /account/support for the hub overview.",
      },
      {
        id: "support-why",
        group: "Why would I use it?",
        title: "When to use docs vs chat vs tickets",
        body: "• Use Documentation & FAQ for how-to steps and “where do I click?” questions.\n• Use live chat for quick navigation help.\n• Open a ticket for billing disputes, bugs, or anything that needs a human follow-up.",
      },
      {
        id: "support-faq-how",
        group: "How to use",
        title: "Step-by-step: browse the Help Centre",
        routes: ["/account/support/faq"],
        body: "1. Open Account → Support → Documentation & FAQ (/account/support/faq).\n2. Pick a card for the product you use (Interview, Survey, Billing, and so on).\n3. Open an article and follow the steps.\n4. Use search on the page if it is shown.\n\nOnly help for services your organisation can see is listed.",
      },
      {
        id: "support-how-to",
        group: "How to use",
        ...
        body: "1. Open /account/support/tickets (or use the help bubble and choose to send a ticket).\n2. Describe what you need — billing, results, usage, or a bug.\n3. Send. Keep the ticket number for follow-up.\n4. Reply in the same ticket when support asks for more detail.\n5. Open tickets stay in the main list; closed tickets move to Archive.",
      },
      {
        id: "support-actions",
        group: "Common actions",
        title: "Ticket actions explained",
        routes: ["/account/support/tickets"],
        body: "• New / Open ticket — starts a conversation with support.\n• Reply — adds your message to the same ticket.\n• Close / Archive — marks the issue done; you can still find it under Archive.\n• Open again — use when a closed issue needs more work (if offered).\n\nClosing does not delete your history — it archives it so open work stays easy to see.",
      },
      {
        id: "support-tips",
        group: "Tips",
        title: "Tips for faster help",
        body: "• Include the campaign or location name and approximate time.\n• Mention what you already tried.\n• Check Documentation & FAQ first for common how-tos.\n• For billing, include the invoice number when you have one.",
      },
      {
        id: "support-avoid",
        group: "Things to avoid",
        title: "Things to avoid",
        body: "• Do not open duplicate tickets for the same issue — reply on the existing one.\n• Do not share passwords in tickets.\n• Do not expect the live assistant to change billing or delete campaigns for you — it is read-only and will point you to the right page.",
      },
      {
        id: "support-related",
        group: "Related features",
        title: "Related features",
        body: "• Billing — /account/billing\n• Profile & password — /settings/profile\n• Public help — https://voxbulk.com/help\n• Contact form — https://voxbulk.com/contact",
      },
      {
