...
export const TEST_VARS_BY_KEY = {
  ...
  usage_warning: {
    organisation_name: 'Riverside Wellness',
    plan_code: 'dental_1',
  ...
  interview_missed_call_followup: {
    ...
    first_name: 'Alex',
    role: 'Senior Software Engineer',
    company_name: 'Riverside Wellness',
  ...
  invoice_document: {
    ...
    invoice_status: 'Paid',
    organisation_name: 'Riverside Wellness',
    client_email: 'billing@riverside.example',
    billing_address: '12 High Street\nLondon\nSW1A 1AA\nUnited Kingdom',
    country_code: 'GB',
    country_name: 'United Kingdom',
    description: 'Business P1 — monthly subscription',
    amount: '£59.99',
    ...
    line_items_html:
      '<tr><td style="padding:10px 12px;border-bottom:1px solid #e2e8f0;">Business P1 — monthly subscription</td><td style="padding:10px 8px;text-align:center;">1</td><td style="padding:10px 12px;text-align:right;">£49.99</td><td style="padding:10px 12px;text-align:right;font-weight:600;">£49.99</td></tr>',
  },
}
...
export const DEFAULT_TEST_VARS = {
  ...
  first_name: 'Alex',
  last_name: 'Demo',
  clinic_name: 'Riverside Wellness',
