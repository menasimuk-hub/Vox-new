...
export const NAV = [
  ...
  [
    ...
    [
      ...
      ['Failed jobs & retries', '/operations/failed-jobs'],
      ['Recovery call queue', '/operations/call-queue'],
      ['Recovery WhatsApp queue', '/operations/whatsapp-queue'],
    ...
    [
      ...
      ['Talk-to-us agent setup', '/marketing/frontpage-call-leads'],
  ...
  [
    ...
    [
      ...
      ['AI demos (pipeline)', '/marketing/leads/demos'],
