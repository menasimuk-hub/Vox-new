          ...
          <form onSubmit={create} noValidate>
            <div className='occ-modal-body' style={{ display: 'grid', gap: 12 }}>
              <p className='muted' style={{ margin: 0 }}>
                Creates a dashboard login. The partner sees Profile settings plus Partner Channel (Overview, Wallet & commission, Send offer). Commission accrues on every paid subscription using their promo code.
              </p>
              {createErr ? (
