...
import { Ban, Check, CheckCircle, Filter, Inbox, List, Plus, RotateCcw, Upload } from 'lucide-react'
import { apiFetch, apiUpload } from '../lib/api'
import './disabledWaTemplatesTheme.css'
    ...
    <div className="dwtTheme">
      <div className="dwt-app">
        ...
        <div className="two-col">
          <div className="card">
            <h3><List size={16} /> Add templates</h3>
          ...
          <div className="card">
            <h3><Upload size={16} /> Upload file</h3>
                  ...
                  sortedItems.map((t) => (
                    <tr key={t.id} className={t.disabled ? 'disabled-row' : ''}>
                      <td>
                        ...
                        {t.target_kind === 'unresolved' ? (
                          <span className="badge-unresolved">NOT FOUND</span>
                        ) : null}
                      </td>
                      ...
                      <td style={{ textAlign: 'center' }}>
                        {t.disabled ? (
                          <button
                            ...
                            disabled={busy}
                            onClick={() => void toggleTemplate(t, false)}
                          >
                          ...
                          <button
                            ...
                            disabled={busy}
                            onClick={() => void toggleTemplate(t, true)}
                          >
                            <Ban size={10} /> Disable
                          </button>
                        )}
