...
export default function WaSurveyIndustryEdit() {
  ...
  return (
    <>
      ...
      <form className="card" style={{ marginBottom: 16 }} onSubmit={saveIndustry}>
        ...
        <div className="cardBody">
          <div className="tableWrap">
            <table className="table">
              ...
              <tbody>
                {typesLoading ? (
                  <tr><td colSpan={7} className="muted">Loading survey types…</td></tr>
                  ...
                  <tr><td colSpan={7} className="muted">No survey types in this industry yet.</td></tr>
                )}
              </tbody>
            </table>
          </div>
          ...
          {!industry.is_hidden ? (
            <form className="waIndustryAddTypeForm" onSubmit={createSurveyType} style={{ marginTop: 16 }}>
              <label className="field">
                ...
                <input className="input" value={newTypeName} onChange={(e) => setNewTypeName(e.target.value)} placeholder="e.g. Post-visit feedback" />
              </label>
              <label className="field">
                <span>Description</span>
