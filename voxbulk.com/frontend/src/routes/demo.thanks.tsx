  ...
  return (
    <>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 px-4 py-14">
        <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-8 text-center shadow-xl">
          <CheckCircle2 className="mx-auto h-12 w-12 text-emerald-400" aria-hidden />
          <h1 className="mt-4 text-3xl font-semibold tracking-tight text-white">Thank you</h1>
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Link
              to="/"
              className="inline-flex items-center justify-center rounded-full border border-white/20 px-5 py-2.5 text-sm font-medium text-white/85"
            >
              Back to homepage
            </Link>
          </div>
