...
export const Route = createFileRoute("/blog")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Field notes from the VoxBulk team on AI-assisted recruitment, multilingual customer feedback, WhatsApp surveys and the future of business conversations." },
      { property: "og:title", content: "VoxBulk Journal" },
      { property: "og:description", content: "Field notes on AI-assisted recruitment, multilingual customer feedback and the future of business conversations." },
        ...
        <section className="border-b border-navy/10">
          <div className="max-w-[1180px] mx-auto px-5 md:px-10 pb-10 md:pb-14">
            ...
            <h1 className="mt-5 font-serif text-[42px] md:text-[68px] leading-[1.02] tracking-[-0.02em] text-navy max-w-[820px]">
              Field notes on <em className="text-gold not-italic">AI, hiring</em>, and the new grammar of business conversations.
            </h1>
            <p className="mt-6 max-w-[640px] text-[16px] md:text-[17px] text-navy/70 leading-[1.65]">
              Long-reads, short essays and case notes from the team building VoxBulk. No SEO filler, no thought-leadership theatre — just what we're learning as we ship.
            </p>
          </div>
        </section>
          ...
          >
            <div className="relative aspect-[4/3] md:aspect-[5/4] rounded-2xl overflow-hidden border border-navy/10 bg-navy">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between text-white">
                <div>
                  <div className="text-[11px] uppercase tracking-[0.2em] text-gold/90">Featured · {featured.category}</div>
                  <div className="mt-2 font-serif text-[26px] md:text-[34px] leading-[1.1] max-w-[420px]">{featured.title}</div>
                </div>
              </div>
            </div>
            <div className="pt-2 md:pt-6">
              <div className="text-[12px] uppercase tracking-[0.18em] text-navy/50">{featured.category} · {formatDate(featured.date)}</div>
              ...
              <div className="mt-6 flex items-center gap-4 text-[13px] text-navy/60">
                ...
                <span className="inline-flex items-center gap-1.5"><Clock size={13} /> {featured.readMins} min read</span>
              </div>
        ...
        <section className="max-w-[1180px] mx-auto px-5 md:px-10 mt-20 md:mt-28">
          <div className="rounded-2xl bg-navy text-white p-8 md:p-12 flex flex-col md:flex-row md:items-center gap-6 md:gap-10">
            <div className="flex-1">
              ...
              <h3 className="mt-2 font-serif text-[26px] md:text-[32px] leading-[1.15]">One thoughtful essay a month. No spam, ever.</h3>
              <p className="mt-3 text-white/60 text-[14.5px] max-w-[520px]">Field-tested writing on AI, hiring and CX — sent only when we have something worth saying.</p>
            </div>
